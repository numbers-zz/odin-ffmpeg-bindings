...
DCT :: struct{
    ...
    get_pixels:proc(block:^i16 /* align 16 */,
                       pixels:^u8 /* align 8 */,
                       line_size:uintptr), //ptrdiff_t. Is this a uintptr?

    bits_per_sample:i32,

    get_pixels_unaligned:proc(block:^i16 /* align 16 */,
		pixels:^u8 /* align 8 */,
		line_size:uintptr), //ptrdiff_t. Is this a uintptr?
}
...
Filter :: struct {
	...
	priv_size:           i32,
	flags_internal:      i32,
	process_command:     proc(ctx: ^Filter_Context, cmd: cstring, arg: cstring, res: cstring, res_len: i32, flags: i32) -> i32,
...
Layout_7point0_Front     :: Layout_5point0       + Channel_BitSet{.Front_Left_of_Center, .Front_Right_of_Center}
Layout_7point1           :: Layout_5point1       + Channel_BitSet{.Back_Left,            .Back_Right}
Layout_7point1_Wide      :: Layout_5point1       + Channel_BitSet{.Front_Left_of_Center, .Front_Right_of_Center}
Layout_7point1_Wide_Back :: Layout_5point1_Back  + Channel_BitSet{.Front_Left_of_Center, .Front_Right_of_Center}
Layout_5point1point2_Back:: Layout_5point1_Back  + Channel_BitSet{.Top_Front_Left, 		 .Top_Front_Right}
Layout_Octagonal         :: Layout_5point0       + Channel_BitSet{.Back_Left,            .Back_Center,           .Back_Right}
Layout_Cube				 :: Layout_Quad			 + Channel_BitSet{.Top_Front_Left, 	 	 .Top_Front_Right,		 .Top_Back_Left, 	.Top_Back_Right}
Layout_5point1point4_Back:: Layout_5point1point2_Back + Channel_BitSet{.Top_Back_Left, .Top_Back_Right}
...
Layout_9point1point4_Back:: Layout_7point1point4_Back + Channel_BitSet{.Front_Left_of_Center, .Front_Right_of_Center}
Layout_Hexadecagonal     :: Layout_Octagonal     + Channel_BitSet{.Wide_Left,            .Wide_Right,            .Top_Back_Left,
...
Layout_22point2          :: Layout_7point1point4_Back  + Channel_BitSet{.Front_Left_of_Center, .Front_Right_of_Center, .Back_Center,      .Low_Frequency_2,
																		.Top_Front_Center, .Top_Center, .Top_Side_Left, .Top_Side_Right, .Top_Back_Center,
...
//===pixelutils.h===
av_pixelutils_sad_fn :: #type proc(src1:[]u8, stride1:uintptr, src2:[]u8, stride2:uintptr)->int
